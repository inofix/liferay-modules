<%--
    geotag.jsp: Provide geo-tagging functionality for liferay assets
                (currently for DLFileEntry and JournalArticle).
    
    Created:    2016-06-27 13:59 by Christian Berndt
    Modified:   2016-06-27 13:59 by Christian Berndt
    Version:    1.0.0
--%>
