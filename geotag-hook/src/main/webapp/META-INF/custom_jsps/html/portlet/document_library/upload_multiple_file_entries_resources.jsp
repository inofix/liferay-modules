<%--
    upload_multiple_file_entries_resources.jsp: A custom version of the file-entry editor
                which provides geo tagging functionality.
    
    Created:    2016-06-27 14:29 by Christian Berndt
    Modified:   2016-06-27 14:29 by Christian Berndt
    Version:    1.0.0
--%>
<%--
/**
...
<script>
    ...
    // Reload the map when the resources panel is shown 
    var metadataContainer = document.getElementById("<portlet:namespace />commonFileMetadataContainer");
    ...
    observer.observe(metadataContainer, config);
