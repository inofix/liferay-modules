...
/**
 * From com.liferay.calendar.util.CalendarResourceUtil.
 * 
 * TODO: Merge with the corresponding class in calendar importer
 * 
 * @author Christian Berndt
 * @created 2015-05-31 23:45
 * @modified 2014-05-31 23:45
 * @version 1.0.0
 *
 */
public class CalendarResourceUtil {
	...
	public static CalendarResource getCalendarResource(
		...
		if (classNameId == userClassNameId) {
			return CalendarResourceUtil.getUserCalendarResource(portletRequest,
					classPK);
		}

		return CalendarResourceServiceUtil.fetchCalendarResource(classNameId,
				classPK);
	}

	public static CalendarResource getGroupCalendarResource(long groupId,
		...
		CalendarResource calendarResource = CalendarResourceLocalServiceUtil
				.fetchCalendarResource(classNameId, groupId);
	...
	public static CalendarResource getUserCalendarResource(long userId,
			ServiceContext serviceContext) throws PortalException,
			SystemException {
		...
		CalendarResource calendarResource = CalendarResourceLocalServiceUtil
				.fetchCalendarResource(classNameId, userId);
		...
		return CalendarResourceLocalServiceUtil.addCalendarResource(userId,
				userGroup.getGroupId(), PortalUtil.getClassNameId(User.class),
				userId, null, null, nameMap, descriptionMap, true,
				serviceContext);
	}

	public static CalendarResource getUserCalendarResource(
			PortletRequest portletRequest, long userId) throws PortalException,
			SystemException {
