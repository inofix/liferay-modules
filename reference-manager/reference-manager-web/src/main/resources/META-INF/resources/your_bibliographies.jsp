...
<%
    ...
    Hits hits = BibliographyServiceUtil.search(themeDisplay.getUserId(), 0,
            themeDisplay.getUserId(), keywords, bibliographySearch.getStart(), bibliographySearch.getEnd(),
            sort);
