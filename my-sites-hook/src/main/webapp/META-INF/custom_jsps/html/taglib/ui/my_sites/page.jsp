...
// customized
final class GroupDescriptiveNameComparator extends OrderByComparator {
...
List<Group> sortableGroups = new ArrayList<Group>(mySiteGroups);

Collections.sort(sortableGroups, new GroupDescriptiveNameComparator(true)); 
...
<c:if test="<%= !mySiteGroups.isEmpty() %>">
    <ul class="taglib-my-sites <%= cssClass %>">
        ...
        for (Group mySiteGroup : sortableGroups) {
