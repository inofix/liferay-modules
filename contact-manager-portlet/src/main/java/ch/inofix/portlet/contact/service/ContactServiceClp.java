...
public class ContactServiceClp implements ContactService {
    ...
    public ContactServiceClp(InvokableService invokableService) {
        ...
        _methodName4 = "createContact";

        _methodParameterTypes4 = new String[] {  };

        _methodName5 = "deleteContact";

        _methodParameterTypes5 = new String[] { "long" };

        _methodName6 = "getContact";

        _methodParameterTypes6 = new String[] { "long" };

        _methodName7 = "updateContact";
    ...
    public ch.inofix.portlet.contact.model.Contact getContact(long contactId)
        ...
        try {
            returnObj = _invokableService.invokeMethod(_methodName6,
                    _methodParameterTypes6, new Object[] { contactId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
