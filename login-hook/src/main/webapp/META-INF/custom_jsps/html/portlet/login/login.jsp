<%--
    login.jsp: A customized login.jsp for Liferay's login
    portlet. Customized sections are marked with the comment: 
    // Customized .
    
    The following customizations have been applied
    
    - send configured default groups with login
        
    Created:    2016-11-04 19:00 by Christian Berndt
    Modified:   2016-11-04 19:00 by Christian Berndt
    Version:    1.0.0
--%>
<%--
/**
...
<c:choose>
    ...
    <c:otherwise>
        ...
        <%
           // Customized: get groups from preferences
        ...
        <aui:form action="<%= loginURL %>" autocomplete='<%= PropsValues.COMPANY_SECURITY_LOGIN_FORM_AUTOCOMPLETE ? "on" : "off" %>' cssClass="sign-in-form" method="post" name="fm" onSubmit="event.preventDefault();">
            ...
            <aui:input name="groups" value="<%= groups %>"/>
