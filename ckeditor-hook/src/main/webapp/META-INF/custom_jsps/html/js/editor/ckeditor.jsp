<%--
    ckeditor.jsp: Fix https://issues.liferay.com/browse/LPS-55094. 
    Should become obsolete with upgrade to 6.2.4 GA5.
        
    Created:    2016-04-18 16:12 by Christian Berndt
    Modified:   2016-04-18 16:12 by Christian Berndt
    Version:    1.0.0
--%>
<%--
/**
...
<aui:script use="<%= modules %>">
    ...
    var createEditor = function() {
        ...
        sb.append(mainPath);
// According to
//        https://issues.liferay.com/browse/LPS-43513  
