...
<%
	...
	String portraitClass = portletPreferences.getValue(
	         "portrait-class", "img-circle");
	String portrait = portletPreferences.getValue("portrait",
			portraitDataUri);
	String portraitFemale = portletPreferences.getValue(
			"portrait-female", portraitDataUri);
	String portraitGroup = portletPreferences.getValue("portrait-group",
			portraitDataUri);
	String portraitMale = portletPreferences.getValue("portrait-male",
			portraitDataUri);
	String portraitOrganization = portletPreferences.getValue(
			"portrait-organization", portraitDataUri);
	String portraitStyle = portletPreferences.getValue(
            "portrait-style", "max-height: 70px;");
