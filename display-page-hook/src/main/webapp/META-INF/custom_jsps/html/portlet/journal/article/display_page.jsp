<%--
    display_page.jsp: This is a customized display page section for the
    journal-article editor. If a field named layoutUuid is available in 
    a structure and an uuid of an default-display page is provided it will
    set the custom display page of the web-content defined by a certain
    structure accordingly. 
    
    It's inspired by the discussion for https://issues.liferay.com/browse/LPS-30115 .
    In order to be deployed as a marketplace product we have to add the 
...
<aui:script use="aui-base">
    var defaultLayoutInput = A.one("input[id^='<portlet:namespace />layoutUuid_']");
