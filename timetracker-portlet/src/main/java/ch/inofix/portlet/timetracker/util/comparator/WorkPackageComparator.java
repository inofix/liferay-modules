...
import ch.inofix.portlet.timetracker.search.TaskRecordSearch;
...
public class WorkPackageComparator extends OrderByComparator {
    ...
    public static final String[] ORDER_BY_FIELDS = { "workPackage" };
    ...
    public int compare(Object obj1, Object obj2) {
        ...
        int value = tastRecord1.getWorkPackage().compareTo(
                tastRecord2.getWorkPackage());
