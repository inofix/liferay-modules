...
public class StartDateComparator extends OrderByComparator {
    ...
    private static final Log _log = LogFactoryUtil
            .getLog(StartDateComparator.class.getName());
    ...
    public StartDateComparator(boolean ascending) {
        _log.info("Constructing new StartDateComparator().");
    ...
    public int compare(Object arg0, Object arg1) {
        ...
        int value = taskRecord0.getStartDate().compareTo(
                taskRecord1.getStartDate());
